...
export default class ModalTest extends Component<Props> {
        ...
        return (
            <View style={{paddingTop: 20, paddingLeft: 10, paddingRight: 10}}>
                ...
                <View style={styles.row}>
                    ...
                    <Button onPress={this._setAnimationType.bind(this, false)}
                            style={this.state.animationType === false ? {backgroundColor: 'red'} : {}}>
                        无动画
                    </Button>
                    <Button onPress={this._setAnimationType.bind(this, true)}
